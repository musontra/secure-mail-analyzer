...
function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-surface font-sans text-fg-soft">
      ...
      <main className="flex flex-1 items-center justify-center px-6">
        <div className="glass-card w-full max-w-sm p-8">
          ...
          {infoMessage && <p className="mt-4 text-center text-sm text-risk-low">{infoMessage}</p>}
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <div className="relative mt-1">
              <input
                ...
                required
                className="w-full rounded-lg border border-accent/15 bg-black/30 px-3 py-2.5 pr-10 text-sm outline-none transition placeholder:text-fg-dim focus:border-accent-soft"
                placeholder="••••••••"
                value={password}
              ...
              <button
                type="button"
                className="absolute right-3 top-1/2 -translate-y-1/2 text-fg-dim hover:text-fg-soft"
            ...
            <label className="mt-4 flex items-center gap-2 text-sm text-fg-soft">
          ...
          <p className="mt-6 text-center text-sm text-fg-soft">
            Hesabınız yok mu?{' '}
            <Link to="/kayit" className="font-semibold text-accent hover:text-accent">
              Kayıt olun
            </Link>
          </p>
        </div>
